...
def test_old_speech_dropped_but_system_and_votes_kept():
    ...
    state.log_public("day", "vote", "Player1 votes for Player2", speaker="Player1")
    state.day = 5
    ...
    assert "Player1 votes for Player2" in text  # votes never dropped
