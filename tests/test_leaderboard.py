...
GAMES = [
    {
        ...
        "players": [
            {"seat": "Player1", "model_key": "alpha", "role": "mafia", "team": "mafia",
             "alive": False, "death_day": 2, "death_cause": "voted_out"},
    ...
    },
    {
        ...
        "players": [
            {"seat": "Player1", "model_key": "alpha", "role": "mafia", "team": "mafia",
             "alive": True, "death_day": None, "death_cause": None},
            {"seat": "Player2", "model_key": "beta", "role": "villager", "team": "town",
             "alive": False, "death_day": 1, "death_cause": "voted_out"},
        ],
        "format_failures": {},
    },
]
...
def test_compute_leaderboard(tmp_path):
    ...
    assert alpha.voted_out_while_mafia == 1  # caught in g1
    ...
    assert beta.voted_out_while_town == 1  # friendly-fired in g2
